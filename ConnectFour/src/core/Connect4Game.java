...
public class Connect4Game implements Connect4State
{
    ...
    public int playerToMoveNum; // 0 or 1 for first and second player
    ...
    */
    ...
    {
        if (board[0][col].getClientProperty("color") == Constants.EMPTY)
        {
            return true;
        }
        else 
    ...
    */
    ...
    {
        int r = Constants.ROWS - 1;
        
        while (r >= 0 && board[r][col].getClientProperty("color") != Constants.EMPTY ) 
        {
            if(r == 0)
            {
    ...
    */
    public int score()
    {
        ...
        for (int r = 0; r < Constants.ROWS; r++) 
        {
            ...
            {
                for (int c = 0; c <= Constants.COLS - 4; c++) 
                {
                    score += score(r, c);
                }
            }
    ...
    */
    public boolean connectFourAnywhere() 
    {
        ...
        for (int r= 0; r < Constants.ROWS && connect4 == false; r++) 
        {
            if (r <= Constants.ROWS - 4) 
            {
                for (int c = 0; c < Constants.COLS && connect4 == false; c++) 
                {
            ...
            {
                for (int c = 0; c <= Constants.COLS - 4 && connect4 == false; c++) 
                {
                    connect4 = connectFour(r, c);
                }
            }
    ...
    */
    public boolean connectFour(int row, int col) 
    {
        ...
        if (row < Constants.ROWS - 3) 
        {
            ...
            for (int r = row; r < row + 4; r++) 
            {
                if (board[r][col].getClientProperty("color") != Constants.CHECKERS[1-playerToMoveNum]) 
                {
                    c4 = false;
                }
            }
        
            if (col < Constants.COLS - 3 && c4 == false) 
            {
                //check up and to the right
                c4 = true;
                ...
                for (int r = row, c = col; r < row + 4; r++, c++) 
                {
                    if (board[r][c].getClientProperty("color") != Constants.CHECKERS[1 - playerToMoveNum]) 
                    {
                        c4 = false;
                    }
                }
        ...
        if (col < Constants.COLS - 3 && c4 == false) 
        {
            ...
            for (int c = col; c < col + 4; c++) 
            {
                if (board[row][c].getClientProperty("color") != Constants.CHECKERS[1 - playerToMoveNum]) 
                {
                    c4 = false;
                }
            }
